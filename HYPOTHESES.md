...
| IG-10 | Le canal « publicites payees » identifie des createurs | **NON MESUREE — ne pas croire la version du 29/08 matin** | J'avais conclu 0 % sur 60 jugements. Mais l'extrait montre a Vincent ne contenait PAS le pseudo detecte : il jugeait du texte publicitaire sans aucun nom visible. Mesure invalide, jugements a refaire. JOURNAL 72 |
...
| SE-09 | Faire valider les sorties brutes d'un outil produit un jeu propre | **REFUTEE** | `LES JONES`, `Mister V diffuse le vendredi` et `Mister V Vous nous l'aviez de` ont tous ete valides « c'est un createur ». La question portait sur une chaine de caracteres, la reponse sur la personne reconnue dedans. JOURNAL 73.2 |
| SE-10 | Les restaurateurs et chefs sont des influenceurs au meme titre | **A TRANCHER — Vincent penche pour non** | Il demande le 29/08 que « le dataset traite separement les restaurateurs ». Leur presence dans une campagne releve d'une autre logique que celle d'un createur de contenu. JOURNAL 73.4 |
