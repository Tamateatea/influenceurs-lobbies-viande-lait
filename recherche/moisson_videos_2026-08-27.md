# Moisson des catalogues YouTube — 2026-08-27

Produit par `outils/exporter_moisson.py`, depuis le fichier de
reprise. Aucun quota consomme : c'est une relecture.

- Chaines moissonnees : **2660**
- Videos examinees : **307 191**
- Videos portant un signal commercial : **25411**
- **Videos citant la filiere viande/lait : 7139**
...
| FlorianOnAir | 734 000 | 122 | ANVOL  Boursin (Groupe Bel)  CIFOG  Herta (Nestle / Casa Tarradellas)  |
| Pierre Croce | 3 790 000 | 115 | CIFOG  CNIEL  Gervais (Danone)  Marie (LDC)  President (Lactalis) |
| HWIJAE | 232 000 | 96 | Marie (LDC)  President (Lactalis) |
| CuisineAZ.com | 156 000 | 91 | Babybel (Groupe Bel)  Boursin (Groupe Bel)  CIFOG  Caprice des Dieux ( |
...
| C'est meilleur quand c'est | 233 000 | 64 | CIFOG  Gervais (Danone)  INTERBEV  Marie (LDC)  President (Lactalis)   |
| Parents | 27 600 | 64 | Lactel (Lactalis)  Marie (LDC)  President (Lactalis)  Societe (Lactali |
| Poisson Fécond | 3 840 000 | 61 | CNIEL  Charal (Bigard)  Marie (LDC)  President (Lactalis)  Societe (La |
...
| La Petite Chef Mumu  | 22 300 | 42 | Boursin (Groupe Bel)  CIFOG  Marie (LDC)  Paysan Breton (Laita)  Soign |
| AgenceBio | 2 670 | 41 | CNIEL  Herta (Nestle / Casa Tarradellas)  INTERBEV  Intercereales  La  |
| Nota Bene | 2 770 000 | 40 | CIFOG  La Vache qui rit (Groupe Bel)  Le Gaulois (LDC)  Marie (LDC)  P |
